...
import { GitIcon, MoonIcon, PythonIcon, SunIcon } from "./Icons";
...
const CustomMobileLink = ({ href, title, className = "", toggle }) => {
  ...
  return (
    ...
    >
      ...
      <span
        className={`
          h-[1px] inline-block bg-primaryDark absolute left-0 -bottom-0.5 group-hover:w-full transition-[width] ease duration-300 
...
const NavBar = () => {
  ...
  return (
    ...
    dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-0
    "
    >
      <button
      ...
      >
        ...
        ></span>
        <span
          className={`bg-dark dark:bg-light block transition-all duration-300 ease-out h-0.5 w-6 rounded-sm 5 ${
            isOpen ? "-rotate-45 -translate-y-1" : "translate-y-0.5"
          }`}
        ></span>
      </button>
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav>
          ...
          <CustomLink                   href="mailto:mena.dominic@gmail.com"
                  target={"_blank"} title="Contact" className="ml-4" />
        </nav>
        ...
        <nav className="flex items-center justify-center flex-wrap">
          ...
          <motion.a
            href="https://www.linkedin.com/in/dominic-mena/"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 ml-3"
      ...
      "
        >
          ...
          <nav className="flex items-center justify-center flex-wrap mt-2">
            ...
            <button
              onClick={() => setMode(mode === "light" ? "dark" : "light")}
              className={`ml-3 flex items-center justify-center rounded-full p-1 md:max-w-[30px]
          ${mode === "light" ? "bg-dark text-light" : "bg-light text-dark"}
          `}
            >
              {mode === "dark" ? (
